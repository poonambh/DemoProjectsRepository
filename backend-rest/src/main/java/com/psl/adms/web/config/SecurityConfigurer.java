...
public class SecurityConfigurer extends ResourceServerConfigurerAdapter {
  ...
  public void configure(final HttpSecurity http) throws Exception {
    ...
    http.cors()
        .configurationSource(corsConfigurationSourceOAuth2())
        .and()
        .headers()
        .frameOptions()
        .disable()
        ...
        .csrf()
        .disable()
        .antMatcher(securityProperties.getApiMatcher())
            .authorizeRequests().anyRequest()
        .authenticated();
  }

  @Bean
  public CorsConfigurationSource corsConfigurationSourceOAuth2() {
